...
function Input({
  ...
  return (
    <TextInput
      className={cn(
        "flex h-12 w-full min-w-0 flex-row items-center border border-border bg-background px-3 py-1 text-base leading-5 text-foreground shadow-sm shadow-black/5 dark:bg-input/30 sm:h-9 rounded-lg",
