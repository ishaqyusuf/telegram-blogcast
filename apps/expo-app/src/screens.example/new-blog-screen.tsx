...
const TagChip = ({ label }: { label: string }) => (
  <View className="flex-row items-center gap-1.5 bg-accent/10 px-3 py-1 rounded-full">
    ...
    <Pressable>
      <Icon name="X" className="size-sm text-accent opacity-70" />
    </Pressable>
  </View>
);
...
const PostDetails = () => (
  <View className="bg-card rounded-2xl p-6 border border-border flex-col gap-6 shadow-sm">
    ...
    <View className="flex-col gap-2">
      ...
      <View className="flex-row flex-wrap items-center gap-2 p-2 rounded-xl bg-muted/50 min-h-[44px]">
        <TagChip label="#spirituality" />
        <TagChip label="#arabic_lit" />
        <TextInput
          className="flex-1 min-w-[100px] text-sm text-foreground p-1"
          ...
          >
            ...
            <View className="flex-col gap-4">
              ...
              <View className="relative flex-row">
                <View className="w-[2px] bg-border mr-4 rounded-full" />
                <TextInput
                  className="flex-1 text-xl leading-8 text-foreground min-h-[150px] text-right"
